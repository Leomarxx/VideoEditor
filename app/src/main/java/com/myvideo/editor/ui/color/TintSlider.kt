...
fun TintSlider(
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Text("色调", fontSize = 11.sp, color = Color(0xFF999999))
        ...
        Canvas(modifier = Modifier.fillMaxWidth().height(20.dp).pointerInput(Unit) {
            ...
            drawRoundRect(Brush.horizontalGradient(listOf(Color(0xFF00FF00), Color(0xFFCCCCCC), Color(0xFFFF00FF))),
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
            Text("绿", fontSize = 9.sp, color = Color(0xFF00FF00))
            Text("品红", fontSize = 9.sp, color = Color(0xFFFF00FF))
        }
    }
}
